...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--train_dir', type=str, default='../../Dataset/train_cropped/train/', help='dir of train data')
        parser.add_argument('--val_dir', type=str, default='../../Dataset/train_cropped/val/', help='dir of train data')
