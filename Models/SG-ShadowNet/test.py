...
parser.add_argument('--generator_1', type=str, default='./pretrained/netG_1_50.pth', help='generator_1 checkpoint file')
parser.add_argument('--generator_2', type=str, default='./pretrained/netG_2_50.pth', help='generator_2 checkpoint file')
parser.add_argument('--savepath', type=str, default='./results', help='save path')
...
opt.im_suf_B = '.jpg'
    ...
    ## ISTD dataset
#    opt.dataroot_A = '../../Dataset/trash_resized/test_A/'
#    opt.im_suf_B = '.jpg'
#    opt.dataroot_B = '../../Dataset/trash_resized/test_B/'
#    opt.im_suf_B = '.jpg'
    
#elif opt.dataset == 'srd':
    ## SRD dataset
#    opt.dataroot_A = '../../Dataset/trash/train_A/'
#    opt.im_suf_A = '.jpg'
#    opt.dataroot_B = '../../Dataset/trash/train_B/'
#    opt.im_suf_B = '.jpg'
#else:
